...
class FlterWidget extends StatefulWidget {
  const FlterWidget({super.key, this.page, this.onFiltersApplied});

  final String? page;
  final Function(Map<String, dynamic>)? onFiltersApplied;

  @override
  State<FlterWidget> createState() => _FlterWidgetState();
}

class _FlterWidgetState extends State<FlterWidget> {
  ...
  void _applyFilters() {
    widget.onFiltersApplied?.call(currentFilters);
