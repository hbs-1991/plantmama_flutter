...
class SimpleMapsModal extends StatefulWidget {
  const SimpleMapsModal({super.key});

  @override
  State<SimpleMapsModal> createState() => SimpleMapsModalState();
}

class SimpleMapsModalState extends State<SimpleMapsModal> {
                          ...
                          Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  'Координаты: ${_currentLocation.latitude.toStringAsFixed(6)}, ${_currentLocation.longitude.toStringAsFixed(6)}',
                                ...
                                ElevatedButton.icon(
                                  ...
                                  label: const Text('Использовать текущую локацию'),
                ...
                children: [
                  ...
                  Text(
                    _selectedAddress.isNotEmpty 
                        ? _selectedAddress 
                        : 'Введите адрес выше или используйте текущую локацию',
                    style: TextStyle(
                      fontSize: 16,
